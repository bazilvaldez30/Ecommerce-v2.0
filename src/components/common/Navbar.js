...
const Navbar = () => {
  ...
  return (
    // <nav className="mt-2 mb-auto my-auto flex content-end border-b-zinc-900 border-b items-center p-3">
    //   <div className='mr-auto'>
    //     <Image src="/ninja.png" width={128} height={77} />
    //   </div>
    //   <div className='flex gap-5'>
    //     <Link className='ml-3' href="/">Home</Link>
    //     <Link className='ml-3' href="/about">About</Link>
    //     <Link className='ml-3' href="/ninjas">Ninja Listing</Link>
    //   </div>
    // </nav>
        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <div className="relative ml-3">
              <button className='text-gray-200 p-2 px-3 bg-orange-500 rounded-3xl'>Sign in</button>
              <div hidden={true}>
                <button type="button" className="flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true" onClick={handleOpenUserMenu} onBlur={handleCloseUser}>
